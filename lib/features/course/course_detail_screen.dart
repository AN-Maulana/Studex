...
class CourseDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF5F5F5), // Menyesuaikan background abu muda
      body: SafeArea(
        child: Stack(
          children: [
            ...
            // Tombol "Try Now" Melayang di bawah (Fixed)
      ...
      child: Column(
        ...
        children: [
          ClipRRect(
            ...
            child: Image.network( // Gunakan Network/Asset sesuai data Anda
            ...
            itemBuilder: (context, index) {
              return Row(
                children: [
                  ...
                  Icon(Iconsax.lock, size: 20.sp, color: Colors.grey.shade300),
                ],
              );
            },
          ),
          SizedBox(height: 24.h),
          _buildActionButton("Join Premium", const Color(0xFFDFFF5E), Colors.black),
        ],
      ),
    );
  }
  ...
  Widget _buildActionButton(String label, Color bg, Color textCol) {
    return Container(
      width: double.infinity,
